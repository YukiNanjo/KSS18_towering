...
//skew_frobenius_map
void EFp3_skew_frobenius_map_p1(EFp3 *ANS,EFp3 *A);//TODO
void EFp3_skew_frobenius_map_p3(EFp3 *ANS,EFp3 *A);//TODO
void EFp3_skew_frobenius_map_p6(EFp3 *ANS,EFp3 *A);//TODO
/*----------------------------------------------------------------------------*/
//EFp9
...
Fp curve_b;
Fp frobenius_constant[18][18];
Fp3 skew_frobenius_constant[18][2];
Fp3 Alpha,Alpha_inv;
mpz_t epsilon1,epsilon2;

Fp TMP1_FP,TMP2_FP,TMP3_FP,TMP4_FP,TMP5_FP,TMP6_FP,TMP7_FP;
